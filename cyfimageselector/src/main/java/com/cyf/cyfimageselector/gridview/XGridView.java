...
//
///**
// * Created by caoyingfu on 2018/2/23.
// */
//
...
//                    if (isDrag && mDragView.getVisibility() == View.VISIBLE) {
...
//        if (isCanDrag && isDrag && mDragMirrorView != null) {
//            switch (ev.getAction()) {
//                case MotionEvent.ACTION_DOWN:
//                    break;
//                case MotionEvent.ACTION_MOVE:
...
//        }
//       // ((GrapeGridview) this).resetPosition();
//        removeDragImage();
//    }
//
//    /**
...
//            if (getChildAt(tmpPosition - getFirstVisiblePosition()).getTag(R.string.app_name) != "add") {
//
...
//        mLayoutParams.x = mOffset2Left + (downX - mPoint2ItemLeft) - 8;
//        mLayoutParams.y = mOffset2Top + (downY - mPoint2ItemTop) - mStatusHeight - 8;
//        //指定布局大小
//        mLayoutParams.width = mDragView.getWidth() + 16;
//        mLayoutParams.height = mDragView.getHeight() + 16;
//        //透明度
